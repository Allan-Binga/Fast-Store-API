...
export default function Home() {
  ...
  return <div className="min-h-screen bg-surface text-on-surface font-body-md">
    ...
    <main className="mx-auto max-w-7xl space-y-12 px-4 py-8 sm:px-8">
      {!browse && <>
        <section aria-labelledby="hero-title" className="overflow-hidden rounded-sm border border-outline-variant bg-surface-container-low shadow-sm">
